...
# ##############################################################################
actions1 = ["Build an Asset Portfolio", "Upload a Portfolio File (CSV)"]
actions = st.selectbox("Select an Option!", actions1)
if actions == 'Upload a Portfolio File [CSV]':
    ...
    st.write("Fill Out the Form below to add a Portfolio")
...
#    units_balance = st.number_input("Input your Units held in Balance", 500)
    ...
    if mf_sel == 'Select Code':
        st.write("Please Select your Fund's Code")
        pass
    else:
